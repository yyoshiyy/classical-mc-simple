...
#define ALTI_SR_PERM                                                           \
    (vector unsigned char)(15, 0, 1, 2, 3, 4, 5, 6, 15, 8, 9, 10, 11, 12, 13,  \
                           14)
#define ALTI_SR_MSK                                                            \
...
/*
 * Stage1 keeps only the 19937 parameter file to stay minimal.
 * Fail fast with a clear message if another MEXP is requested.
 */
#if DSFMT_MEXP != 19937
#error "MC_simple/stage1 ships only dSFMT-params19937.h. Set DSFMT_MEXP=19937."
#endif
